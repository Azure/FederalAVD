...
- **Need custom images + CMK:** Step 1 (securityAndMonitoring) first - the Key Vault must exist before imageManagement can encrypt the gallery and storage account - then Step 2 -> optional Step 3 -> Step 4.
