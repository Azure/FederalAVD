...
if ($DisableUpdates -eq $true) {
    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $auKey -RegistryValue 'NoAutoUpdate' -RegistryType 'DWORD' -RegistryData 1
}
Else {
    If ($DeferQualityUpdatesPeriodInDays -ge 1 -and $DeferQualityUpdatesPeriodInDays -le 30) {
        ...
        Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $wuKey -RegistryValue 'DeferQualityUpdates' -RegistryType 'DWORD' -RegistryData 1
        Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $wuKey -RegistryValue 'DeferQualityUpdatesPeriodInDays' -RegistryType 'DWORD' -RegistryData $DeferQualityUpdatesPeriodInDays
    }
    Else {
        Remove-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $wuKey -RegistryValue 'DeferQualityUpdates'
        Remove-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $wuKey -RegistryValue 'DeferQualityUpdatesPeriodInDays'
    }
    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $wuKey -RegistryValue 'SetComplianceDeadline' -RegistryType 'DWORD' -RegistryData 1
    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $wuKey -RegistryValue 'ConfigureDeadlineForFeatureUpdates' -RegistryType 'DWORD' -RegistryData 7
    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $wuKey -RegistryValue 'ConfigureDeadlineGracePeriodForFeatureUpdates' -RegistryType 'DWORD' -RegistryData 2
    Remove-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $wuKey -RegistryValue 'ConfigureDeadlineNoAutoReboot'
    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $wuKey -RegistryValue 'SetComplianceDeadlineForQU' -RegistryType 'DWORD' -RegistryData 1
    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $wuKey -RegistryValue 'ConfigureDeadlineForQualityUpdates' -RegistryType 'DWORD' -RegistryData 3
    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $wuKey -RegistryValue 'ConfigureDeadlineGracePeriod' -RegistryType 'DWORD' -RegistryData 2
    Remove-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $wuKey -RegistryValue 'ConfigureDeadlineNoAutoRebootForQualityUpdates'
    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $wuKey -RegistryValue 'SetUpdateNotificationLevel' -RegistryType 'DWORD' -RegistryData 1
    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $wuKey -RegistryValue 'UpdateNotificationLevel' -RegistryType 'DWORD' -RegistryData 1
    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $wuKey -RegistryValue 'NoUpdateNotificationDuringActiveHours' -RegistryType 'DWORD' -RegistryData 1

    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $auKey -RegistryValue 'AllowMUUpdateService' -RegistryType 'DWORD' -RegistryData 1
    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $auKey -RegistryValue 'AUOptions' -RegistryType 'DWORD' -RegistryData 4
    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $auKey -RegistryValue 'NoAutoUpdate' -RegistryType 'DWORD' -RegistryData 0
    Remove-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $auKey -RegistryValue 'IncludeRecommendedUpdates'
    Write-Log -Category Info -Message "Setting ScheduledInstallDay to '$ScheduledInstallDay'."
    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $auKey -RegistryValue 'ScheduledInstallDay' -RegistryType 'DWORD' -RegistryData $ScheduledInstallDay
    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $auKey -RegistryValue 'ScheduledInstallTime' -RegistryType 'DWORD' -RegistryData $ScheduledInstallTime
    If ($ScheduledInstallTime -eq 24) {
        Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $auKey -RegistryValue 'AutomaticMaintenanceEnabled' -RegistryType 'DWORD' -RegistryData 1
    }
    Set-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $auKey -RegistryValue 'ScheduledInstallEveryWeek' -RegistryType 'DWORD' -RegistryData 1
    Remove-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $auKey -RegistryValue 'ScheduledInstallFirstWeek'
    Remove-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $auKey -RegistryValue 'ScheduledInstallSecondWeek'
    Remove-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $auKey -RegistryValue 'ScheduledInstallThirdWeek'
    Remove-PolicyRegistryValue -Scope 'Computer' -RegistryKeyPath $auKey -RegistryValue 'ScheduledInstallFourthWeek'
}
Invoke-PolicyUpdate
