...
| Azure Monitor private link | Azure Monitor data collection traffic routed through AMPLS private link scope — no monitoring data over public internet. | Advanced | Deploy or reuse (`deployAzureMonitorPrivateLinkScope`, `azureMonitorPrivateLinkScopeResourceId`) |
