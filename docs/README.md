...
| [Naming Convention](naming-convention.md) | How FederalAVD names resources — CAF default, `namingConvention` parameter, eight naming segments, cross-solution alignment, and scenario test results. |
...
| Page | Description |
| --- | --- |
| [Parameters Reference](parameters.md) | Parameter documentation for all deployment templates — hostpool, imageBuild, imageManagement, securityAndMonitoring, networking — with compliance quick-reference. |
