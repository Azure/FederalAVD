...
| `intuneEntrollment ` | Determines if the virtual machines are enrolled in Intune when they are Entra ID Joined. Used when `identitySolution` = 'EntraId' or 'EntraKerberos-Hybrid' or 'EntraKerberos-CloudOnly'. | bool | true<br/>false | false |
