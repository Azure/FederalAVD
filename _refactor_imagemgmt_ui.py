#!/usr/bin/env python3
"""
Refactor imageManagement/uiFormDefinition.json: remove enableCustomNaming toggle, set CAF defaults.
"""
import json, sys

UI = 'deployments/imageManagement/uiFormDefinition.json'
d = json.load(open(UI, encoding='utf-8-sig'))

# ─── Helpers (same as keyVaults script) ───────────────────────────────────────
...
for name in ('builderInfo', 'componentGuidanceInfo', 'delimiter', 'component1', 'component2'):
