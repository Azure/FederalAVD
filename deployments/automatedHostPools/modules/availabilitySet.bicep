...
module availabilitySet '../../shared/modules/resourceModules/compute/availabilitySets/deploy.bicep' = {
...
output resourceId string = availabilitySet.outputs.resourceId
