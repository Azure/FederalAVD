...
param scalingMethod 'None' | 'PowerManage' | 'CreateDeletePowerManage' = 'None'
...
resource powerOnContributor 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (scalingMethod == 'None' && startVMOnConnect) {
...
resource powerOnOffContributor 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (scalingMethod != 'None') {
...
resource virtualMachineContributor 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (scalingMethod == 'CreateDeletePowerManage') {
